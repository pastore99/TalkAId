...
<head>
    ...
    <%
        int index = Integer.parseInt(request.getParameter("patientIndex"));
        ArrayList<UserInfo> allPatients = (ArrayList<UserInfo>) session.getAttribute("list_user");
    %>
</head>
<body>
<div class="element-home-logopedista">
    <div class="div">
        ...
        <div class="pop-up">
            ...
            <% UserInfo user_selected= allPatients.get(index); %>
                <table>
                    <tr>
                        ...
                        <td>
                            ...
                            <p><b>Email:</b> <%=user_selected.getEmail()%> </p>
                        </td>
                        <td>
...
<script>
    function redirectToGestioneMalattie() {
        window.location.href = 'PatientConditionManager.jsp?userId='+<%=user_selected.getId()%>;
    }
</script>
